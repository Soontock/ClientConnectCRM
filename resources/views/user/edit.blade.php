    ...
    <div class="user-container">
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="editUser-control" id="name" name="name" value="{{ old('name', $user->name) }}" required>
            </div>

            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="editUser-control" id="email" name="email" value="{{ old('email', $user->email) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="userType" class="userType-select ml-2">
                    ...
                    <option value="support" {{ old('userType', $user->userType) == 'support' ? 'selected' : '' }}>Support</option>
                </select> 
            </div>
