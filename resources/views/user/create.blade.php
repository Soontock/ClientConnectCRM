    ...
    <div class="user-container">
        ...
        <form action="{{ route('user.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="create-control" id="name" name="name" value="{{ old('name') }}" required>
            </div>

            <div class="mb-4">
                <label for="email">Email</label>
                <input type="email" class="create-control" id="email" name="email" value="{{ old('email') }}" required>
            </div>

            <div class="mb-4">
                <label for="password">Password</label>
                <input type="password" class="create-control" id="password" name="password" value="{{ old('password') }}" required>
            </div>
