    ...
    <div class="ticket-container">
        ...
        <form action="{{ route('tickets.update', $tickets->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="ticket-control" id="title" name="title" value="{{ old('title', $tickets->title) }}" required>
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <input type="text" class="ticket-control" id="description" name="description" value="{{ old('description', $tickets->description) }}" required>
            </div>
