    ...
    <div class="customer-container">
        ...
        <form action="{{ route('customer.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="customer-control" id="name" name="name" value="{{ old('name') }}"
                    required>

                <label for="email">Email</label>
                <input type="email" class="customer-control" id="email" name="email" value="{{ old('email') }}"
                    required>
                ...
                <input type="number" class="customer-control" id="phoneNum" name="phoneNum"
